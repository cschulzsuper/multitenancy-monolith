...
public sealed class Get : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    [InlineData("v1-extension", MockWebApplication.MockAdmin)]
    [InlineData("v1-extension", MockWebApplication.MockIdentity)]
    [InlineData("v1-extension", MockWebApplication.MockDemo)]
    [InlineData("v1-extension", MockWebApplication.MockChief)]
    [InlineData("v1-extension", MockWebApplication.MockChiefObserver)]
    [InlineData("v1-extension", MockWebApplication.MockMember)]
    [InlineData("v1-extension", MockWebApplication.MockMemberObserver)]
