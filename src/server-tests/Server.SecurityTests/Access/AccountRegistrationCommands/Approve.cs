...
public sealed class Approve : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Approve_ShouldBeUnauthorized_WhenNotAuthenticated()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/api/access/account-registrations/{validAccountRegistration}/approve");
    ...
    public async Task Approve_ShouldBeUnauthorized_WhenInvalid(int mock)
    {
        // Arrange
        var validAccountRegistration = 1;
