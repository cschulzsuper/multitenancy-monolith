...
public sealed class Get : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Get_ShouldSucceed_WhenExists()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/api/b1/schedule/planned-jobs/{existingPlannedJob.UniqueName}");
    ...
    public async Task Get_ShouldFail_WhenAbsent()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/api/b1/schedule/planned-jobs/{absentPlannedJob}");
        request.Headers.Authorization = _factory.MockValidIdentityAuthorizationHeader();
    ...
    public async Task Get_ShouldFail_WhenInvalid()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/api/b1/schedule/planned-jobs/{invalidPlannedJob}");
        request.Headers.Authorization = _factory.MockValidIdentityAuthorizationHeader();
