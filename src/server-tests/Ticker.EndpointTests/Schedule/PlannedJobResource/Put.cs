...
public sealed class Put : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Put_ShouldSucceed_WhenValid()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Put, $"/api/b1/schedule/planned-jobs/{existingPlannedJob.UniqueName}");
    ...
    public async Task Put_ShouldFail_WhenInvalid()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Put, $"/api/b1/schedule/planned-jobs/{invalidPlannedJob}");
        request.Headers.Authorization = _factory.MockValidIdentityAuthorizationHeader();
    ...
    public async Task Put_ShouldFail_WhenAbsent()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Put, $"/api/b1/schedule/planned-jobs/{absentPlannedJob}");
        request.Headers.Authorization = _factory.MockValidIdentityAuthorizationHeader();
