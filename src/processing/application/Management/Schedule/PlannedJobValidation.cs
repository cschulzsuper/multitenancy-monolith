...
internal static class PlannedJobValidation
{
    ...
    static PlannedJobValidation()
    {
        ...
        _insertValidator.AddRules(x => x.Expression, RequiredTextValidator.CreateRules("expression"));
        ...
        _updateValidator.AddRules(x => x.Expression, RequiredTextValidator.CreateRules("expression"));
