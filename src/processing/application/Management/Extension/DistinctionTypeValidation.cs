...
internal static class DistinctionTypeValidation
{
    ...
    static DistinctionTypeValidation()
    {
        ...
        _insertValidator.AddRules(x => x.CustomProperties, UniquePropertyValueValidator<DistinctionTypeCustomProperty>.CreateRules(x => x.UniqueName, "custom property unique name"));
        ...
        _updateValidator.AddRules(x => x.CustomProperties, UniquePropertyValueValidator<DistinctionTypeCustomProperty>.CreateRules(x => x.UniqueName, "custom property unique name"));
