...
internal sealed class TickerUserDependentCommandHandler : ITickerUserDependentCommandHandler
{
    ...
    public TickerUserDependentCommandHandler(
    ...
    public async Task<ClaimsIdentity> AuthAsync(TickerUserDependentAuthCommand command)
    {
    ...
    public async Task<ClaimsIdentity> ConfirmAsync(TickerUserDependentConfirmCommand command)
    {
        var client = command.Client;
    ...
    public async Task PostAsync(TickerUserDependentPostCommand command)
    {
